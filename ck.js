...
function decisions(p, t=new Array()) {
    ...
    switch(pp) {
        ...
        case 'enfant': // SI aventurier : Prestige, opinion, Or adopté SINON procréer ; survivre
            ...
            e20.add("emprisonner SI adoption/aventurier ET Sombres connaissances ET Outils du tortionnaire ET NON mort ET NON perte Prestige");     
            e20.add("Or SI adoption/aventurier ET NON mort ET NON perte Prestige");
            e20.add("hameçon OU secret SI adoption/aventurier ET paiement ET NON mort ET NON perte Prestige");
...
function evidence(id, texte, ttLeTps=false) {
  ...
  function calculate() {
    ...
    evidence('militaireResult', "<p>"+sansDoublon(militaireResult)+"</p><h2>Affecter des commandants</h2><p>"+sansDoublon(armeesResult)+"</p>");
    ...
    liDec(listeDecisions, 'Mesures désespérées - Abattage des animaux', 'dec-maj-av-7', decisionOuNon(decisionsResult,
            ...
            new Set(["Prestige"])));
    // Décisions pays
    listeDecisions = document.getElementById('decPays');
